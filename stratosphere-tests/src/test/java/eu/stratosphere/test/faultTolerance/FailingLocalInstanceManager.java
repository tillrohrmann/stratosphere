...
public class FailingLocalInstanceManager extends LocalInstanceManager {

	public FailingLocalInstanceManager(TaskManagerFactory taskManagerFactory){
		super(taskManagerFactory);
	}
}
